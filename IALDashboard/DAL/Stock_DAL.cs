    ...
    public class Stock_DAL : BaseDataAccessLayer
    {
        ...
        public DataTable StockTableTemp()
        {
            ...
            try
            {
               ...
               + " NVL(DHAMRAI_CKD_XX_DO_ISSUED,0) DHAMRAI_CKD_XX_DO_ISSUED, NVL(DHAMRAI_CKD_XX_BOOKED_DAP,0) DHAMRAI_CKD_XX_BOOKED_DAP ,NVL(DHAMRAI_CKD_XX_DPD,0) DHAMRAI_CKD_XX_DPD, "
               ...
               + " NVL(DHAMRAI_CBU_XX_BOOKED_DAP,0) DHAMRAI_CBU_XX_BOOKED_DAP, "
               ...
               + " (COALESCE(DHAMRAI_CKD_XX_BOOKED_DAP ,0) + COALESCE(JOYDEBPUR_XX_BOOKED ,0) + COALESCE(CUMILLA_XX_BOOKED ,0) + COALESCE(CHATTOGRAM_XX_BOOKED ,0) + COALESCE(JASHORE_XX_BOOKED ,0) + COALESCE(BOGRA_XX_BOOKED ,0) + COALESCE(DHAMRAI_CBU_XX_BOOKED_DAP ,0)) AS BOOKED, "
