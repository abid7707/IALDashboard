    ...
    public class Stock_DAL : BaseDataAccessLayer
    {
        ...
        public DataTable StockTableTemp()
        {
            ...
            try
            {
               ...
               + " NVL(BUS_BODY_QTY,0) BUS_BODY_QTY, NVL(DEALER_PD_QTY,0) DEALER_PD_QTY, NVL(FAIR_DEMO_QTY,0) FAIR_DEMO_QTY,"
               + " NVL(LC_QTY,0) LC_QTY, NVL(OUTSIDE_BWS_QTY,0) OUTSIDE_BWS_QTY, NVL(TOTAL_OT_QTY,0) TOTAL_OT_QTY, "
               + " NVL(TRANSPORTT_QTY,0) TRANSPORTT_QTY, NVL(DHAMRAI_CKD_XX_RFD_CKD,0) DHAMRAI_CKD_XX_RFD_CKD ,NVL(DHAMRAI_CBU_XX_RFD_CBU,0) DHAMRAI_CBU_XX_RFD_CBU, "
               ...
               + " (COALESCE(DHAMRAI_CKD_XX_RFD_CKD, 0) + COALESCE(DHAMRAI_CBU_XX_RFD_CBU,0) + COALESCE(JOYDEBPUR_XX_RFD, 0) + COALESCE(CUMILLA_XX_RFD, 0) + COALESCE(CHATTOGRAM_XX_RFD, 0) + COALESCE(JASHORE_XX_RFD,0) + COALESCE(BOGRA_XX_RFD,0)) AS RFD, "
               ...
               + " COALESCE(DHAMRAI_CKD_XX_RFD_CKD, 0) + COALESCE(DHAMRAI_CBU_XX_RFD_CBU,0) + COALESCE(JOYDEBPUR_XX_RFD, 0) + COALESCE(CUMILLA_XX_RFD, 0) + COALESCE(CHATTOGRAM_XX_RFD, 0) + COALESCE(JASHORE_XX_RFD,0) + COALESCE(BOGRA_XX_RFD,0)) AS TOTAL_QTY"
        ...
        public DataTable DailyStockProcessData()
        {
            ...
            try
            {
                ...
                + "    sum(NVL(DHAMRAI_CKD_XX_RFD_CKD, 0)) DHAMRAI_CKD_XX_RFD_CKD, "
                + "    sum(NVL(DHAMRAI_CBU_XX_RFD_CBU, 0)) DHAMRAI_CBU_XX_RFD_CBU, "
                ...
                + "    ) AS DO_ISSUED, "
                + "    sum( "
                + "        COALESCE(DHAMRAI_CKD_XX_RFD_CKD, 0) + COALESCE(DHAMRAI_CBU_XX_RFD_CBU, 0) + COALESCE(JOYDEBPUR_XX_RFD, 0) + COALESCE(CUMILLA_XX_RFD, 0) + COALESCE(CHATTOGRAM_XX_RFD, 0) + COALESCE(JASHORE_XX_RFD, 0) + COALESCE(BOGRA_XX_RFD, 0) "
                + "    ) AS RFD, "
                + "    sum( "
                + "        COALESCE(DHAMRAI_CBU_XX_PDI_PTS, 0) + COALESCE(JOYDEBPUR_XX_PDI_PTS, 0) + COALESCE(CUMILLA_XX_PDI_PTS, 0) + COALESCE(CHATTOGRAM_XX_PDI_PTS, 0) + COALESCE(JASHORE_XX_PDI_PTS, 0) + COALESCE(BOGRA_XX_PDI_PTS, 0) + COALESCE(DHAMRAI_CKD_XX_PDI_PTS, 0) + COALESCE(DHAMRAI_CKD_XX_BOOKED_DAP, 0) + COALESCE(JOYDEBPUR_XX_BOOKED, 0) + COALESCE(CUMILLA_XX_BOOKED, 0) + COALESCE(CHATTOGRAM_XX_BOOKED, 0) + COALESCE(JASHORE_XX_BOOKED, 0) + COALESCE(BOGRA_XX_BOOKED, 0) + COALESCE(DHAMRAI_CBU_XX_BOOKED_DAP, 0) + COALESCE(DHAMRAI_CKD_XX_DO_ISSUED, 0) + COALESCE(JOYDEBPUR_XX_DO_ISSUED, 0) + COALESCE(CUMILLA_XX_DO_ISSUED, 0) + COALESCE(CHATTOGRAM_XX_DO_ISSUED, 0) + COALESCE(JASHORE_XX_DO_ISSUED, 0) + COALESCE(BOGRA_XX_DO_ISSUED, 0) + COALESCE(DHAMRAI_CBU_XX_DO_ISSUED, 0) + COALESCE(DHAMRAI_CKD_XX_RFD_CKD, 0) + COALESCE(DHAMRAI_CBU_XX_RFD_CBU, 0) + COALESCE(JOYDEBPUR_XX_RFD, 0) + COALESCE(CUMILLA_XX_RFD, 0) + COALESCE(CHATTOGRAM_XX_RFD, 0) + COALESCE(JASHORE_XX_RFD, 0) + COALESCE(BOGRA_XX_RFD, 0) "
                + "    ) AS TOTAL_QTY "
                + " FROM REPORTDB.IAL_DAILY_STK_RPT_PROS_DATA "
                + " GROUP BY PARTDES, "
                + "    PART_NO, "
